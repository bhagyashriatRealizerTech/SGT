...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private static final String TIMETABLE ="CREATE TABLE TimeTable(TTId INTEGER PRIMARY KEY   AUTOINCREMENT,Std Text,Div Text,TmTbleName TEXT,Imglst TEXT,Givenby TEXT,TTDate TEXT,HasSyncedUp TEXT,Description TEXT,SharedLink TEXT)";
